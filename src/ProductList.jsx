...
function PlantItem({ plant, isInCart, onAddToCart }) {
...
function PlantsList({ plants, category, onAddToCart, isPlantInCart }) {
  return (
...
function ProductList({ onHomeClick }) {
  ...
  return (
    <div>
            ...
            <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
              <h1 className="cart">
                ...
                <span className="cart_quantity_count">
                  {cart.reduce((val, item) => val + item.quantity, 0)}
                </span>
              </h1>
            </a>
          </div>
      ...
      {!showCart ? (
        <div className="product-grid">
          {plantsArray.map((plantsCateory) => (
            <PlantsList
              plants={plantsCateory.plants}
              category={plantsCateory.category}
